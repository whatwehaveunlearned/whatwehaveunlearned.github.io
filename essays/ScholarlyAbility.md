...
This work is constructing on previuos work and systems we developed in the previous years. My contribution to this paper is around 10% setting up tools and pipeline steps and other the subsystems involved in the study. 
...
My contribution to this paper is around 90%, the definition, research. design, implementation and iterations on the different visualization tools used in the system as well as writing the paper.
...
My contribution to this paper was around 30% helping with some of the resarch sections of the study and writing some of the sections. 
...
My contribution to this paper was about 40% of the total work. I defined and helped envision and develop the structure of the architecture to perform live visual queries. I wrote sections of this paper.
...
My contribution to this paper was around 90% of the total work. Research and implement the visualizations, interaction design and the full visualization dashboard of the tool. As well as writing the paper and the theoretic backgrounds.
...
My contribution to this paper was 40% of the work to research visual analytic techniques to simplify the analyst analysis. Researching techniques on how to implement the analysis directly in the visual elements instead of the raw data as well as writing some of the sections. 
