...
My contribution to this work was setting up the study and the theorital framework to ground the results to.  
...
This work is constructing on previuos work and systems we developed in the previous years. My contributions to this work are setting up tools and pipelinbe steps and other the subsystems involved in the study. 
...
My contributions to this work were to analyse some of the corpuses and help to develop the coding mechanisms and the utterances that should be recorded. I also worked researching and implementing some of the pieces of the NL pipeline.
